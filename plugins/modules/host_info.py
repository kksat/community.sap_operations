...
extends_documentation_fragment:
  - community.sap_operations.saphost
...
- name: Collection information about SAP instances installed on the current host
  community.sap_operations.host_info:
...
from ansible_collections.community.sap_operations.plugins.module_utils.saphost import (  # pyright: ignore[reportMissingImports]
