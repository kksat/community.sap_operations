...
- name: Test filter `valid_sid`, this assertion is True
  ansible.builtin.assert:
    that: ( 'ABC'| community.sap_operations.valid_sid )

- name: Test filter `valid_sid`, this assertion is True
  ansible.builtin.assert:
    that: not ( 'AbC'| community.sap_operations.valid_sid )

- name: Test filter `valid_sid`, this assertion is True
  ansible.builtin.assert:
    that: not ( 'ADD'| community.sap_operations.valid_sid )

- name: Test filter `valid_sid`, this assertion is True
  ansible.builtin.assert:
    that: not ( '1BC'| community.sap_operations.valid_sid )

- name: Test filter `valid_sid`, this assertion is True
  ansible.builtin.assert:
    that: not ( 'A?C'| community.sap_operations.valid_sid )
"""
